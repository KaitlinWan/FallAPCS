...
//2017-10-12
	...
	private static int headsCtr;
	private static int tailsCtr;
	  ...
	  ***/
	  ...
	  public static int getMatchCtr() {
			return matchCtr;
			}
	  
	  public static void setMatchCtr(int matchCtr) {
			Coin.matchCtr += matchCtr;
			}

	  public static int getFlipCtr() { 
	    return flipCtr;
	  }
	  ...
	  ***/
	  public static void reset( String s, double d )
	  { 
	    flipCtr = 0;
	    tailsCtr = 0;
	    headsCtr = 0;
